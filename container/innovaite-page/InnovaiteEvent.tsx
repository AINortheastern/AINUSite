...
import { FaMapMarkerAlt, FaCalendarAlt, FaClock, FaTrophy, FaUsers, FaTicketAlt } from 'react-icons/fa';
  ...
  return (
    <section className="w-full padding-y rounded-t-[20px] z-20 relative mt-[-15px]">
      ...
      <div className="pl-[50px] sm:px-[20px] xm:px-[20px]">
        ...
        InnovAIte Hackathon is a 30-hour intensive project development event bringing together innovative students to solve real-world challenges through AI.
        </p>
      </div>
...
<div className="w-full grid grid-cols-3 gap-0 mt-12 px-12">
  ...
  >
    ...
    <p className='text-lg font-medium font-NeueMontreal  text-center'>
      February 15th: 10:00 A.M. - 9:00 P.M.
    </p>
    <p className='text-lg font-medium font-NeueMontreal  text-center'>
      February 16th: 10:00 A.M. - 7:00 P.M.
    </p>
  </div>
  <div 
    className="aspect-square p-6 flex flex-col justify-center items-center" 
...
<div className="w-full grid grid-cols-3 gap-0 mt-0 px-12">
  ...
  >
    ...
    <p className='text-lg font-medium font-NeueMontreal  text-center'>
      Panel of 2-3 professors from participating institutions
      Awards and perks available
    </p>
  </div>
  <div 
    className="aspect-square p-6 flex flex-col justify-center items-center" 
			...
			{eventsItems.map((item) => (
				<div
					...
					<div className="w-full flex items-center justify-between py-[10px] padding-x">
						...
						<div className="w-[50%] sm:w-full xm:w-full">
							{/*register button*/}
						<button className="w-[130px] h-[40px] bg-[#212121] text-white font-NeueMontreal 
											font-normal text-sm uppercase rounded-[10px] flex items-center 
											justify-center"
